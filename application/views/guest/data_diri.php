<div class="container my-4">
    <div class="card">
        <div class='card-header bg-info text-white'>INFO PERJALANAN</div>
    ...
    <div class='card'>
        <div class='card-header bg-info text-white'>Detail Penumpang</div>
        <div class='card-body'>
    ...
    <hr>
    <div class='card'>
        <div class='card-header bg-info text-white'>Detail Pemesan</div>
        <div class='card-body'>
            <div class='row'>
                <div class='col-md-4'>
