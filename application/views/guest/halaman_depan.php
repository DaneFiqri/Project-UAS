	<div class="jumbotron jumbotron-fluid">
	  <div class="container">
	    <div class="row">
	    	<div class="col-md-8">
	    		<br> <br> <br>
	    		<h1 class="display-4 text-white bayangan">Selamat Datang di Kereta Jatox</h1>
	    		<h5 class="text-white bayangan">Anda dapat melakukan pemesanan Tiket Kereta Api Online dengan Mudah, Anda dapat memesan Tiket sesuka hati</h5>	    		
	    	</div>
	    	<div class="col-md-4">
